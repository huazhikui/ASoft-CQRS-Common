...
namespace ASoft.IO
{
    public class SerialPortConnection1
    {
        ...
        public SerialPortConnection1(string comPortName)
        {
        ...
        public SerialPortConnection1(string comPortName, int baudRate, Parity parity, int dataBits, StopBits stopBits)
        {
