...
namespace ASoft
{
    public class CookieHelper
    {
        ...
        public static void SetCookie(string cookieName, string value, DateTime? expires, bool httpOnly = false)
        {
        ...
        /// <param name="expires"></param>
        /// <returns></returns>
        public static bool SetCookie(string cookieName, DateTime expires)
        { 
            HttpResponse response = HttpContext.Current.Response;
            if (response != null)
            {
